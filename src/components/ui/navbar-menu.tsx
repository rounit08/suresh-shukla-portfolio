  ...
  return (
    <div className="relative bg-white">
      ...
      {active !== null && (
        ...
        >
          {active === item && (
            <div className="absolute top-[calc(100%_+_1.2rem)] left-1/2 transform -translate-x-1/2 p-0">
              <motion.div
                transition={transition}
...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="relative   w-10/12 border border-transparent  text-black dark:border-white/[0.2]  shadow-input flex items-center gap-6 justify-center space-x-4 px-8 py-1 "
    >
      {children}
    </nav>
  );
